...
# Define the path to the OneImlx.Shared solution file
$ONEIMLX_SOLUTION_PATH = "./OneImlx.Shared.Solution.sln"  # Specify the solution or test project path
...
Write-Host "[INFO] Running OneImlx.Shared code coverage reports..." -ForegroundColor $ONEIMLX_COLOR_MAGENTA
...
if (-Not $ONEIMLX_COBERTURA_FILES) {
    Write-Host "[ERROR] No Cobertura code coverage reports were generated for the OneImlx.Shared package." -ForegroundColor Red
    exit 1
}
...
if (Get-Command reportgenerator -ErrorAction SilentlyContinue) {
    ...
    reportgenerator `
        ...
        -reporttypes:Html `
        -title:"OneImlx.Shared Coverage Report"
...
Write-Host "[INFO] OneImlx.Shared framework coverage successfully completed." -ForegroundColor $ONEIMLX_COLOR_GREEN
