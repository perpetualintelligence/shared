This package contains the cross-platform protocols and stahndars abstrations for Perpetual Intelligence L.L.C. managed services, frameworks, and tools. Applications owners can use these components to build low-level or foundational elements.
