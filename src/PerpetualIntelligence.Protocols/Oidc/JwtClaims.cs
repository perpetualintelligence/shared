...
namespace PerpetualIntelligence.Protocols.Oidc
{
    ...
    public static class JwtClaims
    {
        ...
        /// access_token value with SHA-256, then take the left-most 128 bits and base64url encode them. The at_hash
        ...
        /// the acting party to whom authority has been delegated.The "act" claim value is a JSON object and members in
        /// the JSON object are claims that identify the actor. The claims that make up the "act" claim identify and
        /// possibly provide additional information about the actor.
        /// </summary>
        public const string Actor = "act";

        /// <summary>
        /// End-User's preferred postal address. The value of the address member is a JSON structure containing some or
        /// all of the members defined in http://openid.net/specs/openid-connect-basic-1_0-32.html#AddressClaim
        /// </summary>
        ...
        /// as an audience value. It MAY also contain identifiers for other audiences. In the general case, the aud
        ...
        /// indicates the End-User authentication did not meet the requirements of ISO/IEC 29115 level 1. Authentication
        /// using a long-lived browser cookie, for instance, is one example where the use of "level 0" is appropriate.
        ...
        /// SHOULD be used as the acr value; registered names MUST NOT be used with a different meaning than that which
        /// is registered. Parties using this claim will need to agree upon the meanings of the values used, which may
        /// be context-specific. The acr value is a case sensitive string.
        /// </summary>
        ...
        /// when auth_time is requested as an Essential Claim, then this Claim is REQUIRED; otherwise, its inclusion is OPTIONAL.
        /// </summary>
        public const string AuthenticationTime = "auth_time";

        /// <summary>
        /// Code hash value. Its value is the base64url encoding of the left-most half of the hash of the octets of the
        ...
        /// SHA-512, then take the left-most 256 bits and base64url encode them. The c_hash value is a case sensitive string.
        /// </summary>
        public const string AuthorizationCodeHash = "c_hash";

        /// <summary>
        /// The party to which the ID Token was issued. If present, it MUST contain the OAuth 2.0 Client ID of this
        /// party. This Claim is only needed when the ID Token has a single audience value and that audience is
        /// different than the authorized party. It MAY be included even when the authorized party is the same as the
        /// sole audience. The azp value is a case sensitive string containing a StringOrURI value.
        /// </summary>
        ...
        /// the underlying platform's date related function, providing just year can result in varying month and day, so
        ...
        /// address was controlled by the End-User at the time the verification was performed. The means by which an
        ...
        /// <summary>
        /// Defines a set of event statements that each may add additional claims to fully describe a single logical
        /// event that has occurred.
        /// </summary>
        public const string Events = "events";

        /// <summary>
        /// The exp (expiration time) claim identifies the expiration time on or after which the token MUST NOT be
        /// accepted for processing, specified as the number of seconds from 1970-01-01T0:0:0Z
        /// </summary>
        ...
        /// <summary>
        /// End-User's gender. Values defined by this specification are "female" and "male". Other values MAY be used
        ...
        /// <summary>
        /// The iat (issued at) claim identifies the time at which the JWT was issued, , specified as the number of
        ...
        /// <summary>
        /// JWT ID. A unique identifier for the token, which can be used to prevent reuse of the token. These tokens
        /// MUST only be used once, unless conditions for reuse were negotiated between the parties; any such
        ...
        /// <summary>
        /// The "may_act" claim makes a statement that one party is authorized to become the actor and act on behalf of
        /// another party. The claim value is a JSON object and members in the JSON object are claims that identify the
        /// party that is asserted as being eligible to act for the party identified by the JWT containing the claim.
        /// </summary>
        ...
        /// be present, with the names being separated by space characters. Also note that in some cultures, middle
        /// names are not used.
        /// </summary>
        ...
        /// extension, it is RECOMMENDED that the extension be represented using the RFC 3966 [RFC3966] extension
        ...
        /// contractual agreements within which the parties are operating. When true, the phone_number Claim MUST be in
        /// E.164 format and any extensions MUST be represented in RFC 3966 format.
        /// </remarks>
        public const string PhoneNumberVerified = "phone_number_verified";

        /// <summary>
        /// URL of the End-User's profile picture. This URL MUST refer to an image file (for example, a PNG, JPEG, or
        /// GIF image file), rather than to a Web page containing an image.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Shorthand name by which the End-User wishes to be referred to at the RP, such as janedoe or j.doe. This
        /// value MAY be any valid JSON string including special characters such as @, /, or whitespace. The relying
        /// party MUST NOT rely upon this value being unique
        /// </summary>
        ...
        /// <summary>
        /// OpenID Connect requests MUST contain the "openid" scope value. If the openid scope value is not present, the
        /// behavior is entirely unspecified. Other scope values MAY be present. Scope values used that are not
        /// understood by an implementation SHOULD be ignored.
        /// </summary>
        public const string Scope = "scope";

        /// <summary>
        /// Session identifier. This represents a Session of an OP at an RP to a User Agent or device for a logged-in
        /// End-User. Its contents are unique to the OP and opaque to the RP.
        /// </summary>
        public const string SessionId = "sid";

        /// <summary>
        /// State hash value. Its value is the base64url encoding of the left-most half of the hash of the octets of the
        /// ASCII representation of the state value, where the hash algorithm used is the hash algorithm used in the alg
        /// Header Parameter of the ID Token's JOSE Header. For instance, if the alg is HS512, hash the code value with
        /// SHA-512, then take the left-most 256 bits and base64url encode them. The c_hash value is a case sensitive string.
        /// </summary>
